                ...
                {cart.map((item) => {
                  ...
                  return (
                    <motion.div
                      ...
                      style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.8rem 0' }}
                    >
                      {/* 1. Title + modifiers */}
                      <div style={{ flex: '1 1 0', minWidth: 0, overflow: 'hidden' }}>
                        ...
                        {item.selectedOptions?.length > 0 && (
                          <div className="cart-item-modifiers" style={{ margin: 0, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                      ...
                      <div
                        ...
                        style={{ margin: 0, padding: '0.2rem 0.3rem', gap: '0.4rem', flexShrink: 0, height: '28px' }}
                      >
                        <motion.button
                          whileTap={{ scale: 0.85 }}
                      ...
                      {/* 4. Price */}
                      <span style={{ fontWeight: '800', color: 'var(--primary)', fontSize: '0.9rem', flexShrink: 0, whiteSpace: 'nowrap', minWidth: '42px', textAlign: 'right' }}>
